...
@section('content')
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Register Email</div>
                <div class="card-body">
                    <form action="{{ route('post.email') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Register Email">
                        </div>
                    </form>
                </div>
            </div>
